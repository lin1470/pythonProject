...
def main():
    ...
    print "here is the begining."
    bandname="Nirvana"
    results = query_by_name(ARTIST_URL, query_type["simple"], bandname)#the query_type provide a dictionary for the function
    # print "the len of artists of first aid kit\n"
    # name_of_bands = [r['name'] for r in results['artists']]
    # print name_of_bands
    # print "\n"
    print "the begin area for the band "+bandname
    for ra in results['artists']:
        if ra['name']==bandname:
            pretty_print(ra)
